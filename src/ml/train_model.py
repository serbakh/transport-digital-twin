...
# -----------------------------------------------------------------------------
# 11. Побудова графіків залежності якості від обсягу даних
# -----------------------------------------------------------------------------
...
plt.title("Вплив обсягу синтетичних даних на MAE")
plt.xlabel("Кількість сценаріїв у навчальній вибірці")
plt.ylabel("MAE прогнозу тоннажу, т")
plt.grid(True)
plt.tight_layout()

mae_plot_path = OUTPUT_DIR / "ml_learning_mae.png"
...
plt.title(
    ...
    "на точність прогнозування вузького місця"
)
plt.xlabel("Кількість сценаріїв у навчальній вибірці")
plt.ylabel("Accuracy")
plt.grid(True)
...
bottleneck_plot_path = OUTPUT_DIR / "ml_learning_bottleneck.png"
...
# -----------------------------------------------------------------------------
# 12. Аналіз важливості вхідних ознак
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 13. Формування фінальних моделей на повному наборі даних
#
...
# -----------------------------------------------------------------------------
# 14. Збереження фінальних моделей і переліку ознак
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 15. Збереження узагальнених показників якості моделей
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# 16. Контрольний індикатор завершення
# -----------------------------------------------------------------------------
